...
效應評估問句：對於成績差的學生，即使平均教育溢酬越高，上大學就越有利？

造成選擇性偏誤原因：較好的學校比較差的學校輟學率低，所以上好學校的報酬率會高於上差學校的報酬率，因此雖然都是能力差不多的學生，一旦分別進入較好及較差學校，此時立足點馬上不同，所以成績差的學生其教育報酬率低不單純是自身能力的問題，而是因為他進入比較差的學校，進而造成讀較差學校的學生對於教育溢酬的高估。
```
```
