...
smsa：
如果住在美國大都會地區，
因為本身的生活水準與機能都不錯，會比較有機會接受教育，
造成他們的立足點相對於其他地區的人還高。
所以如果單純比較不同教育年數下的薪資，
其中的差異除了反應教育效果外，也反應了「是否住在美國大都會地區」。

從計算的數值得出educ與smsa兩者的相關係數0.2243087，的確顯著。
所以如果是住在美國大都會地區的就業者，wage有可能越高，經由計算兩者的相關係數有0.1778852，的確有影響性，故單純比較wage與educ，有可能只是在反映「是否住在美國大都會地區」生活機能的好壞。

profocc：
如果從事具有專業技能的工作職位，
因為他們的工作專業，通常都需要比較高的受教年數，
造成他們的立足點相對於其他職業的人還高。
所以如果單純比較不同教育年數下的薪資，
其中的差異除了反應教育效果外，也反應了「是否從事具有專業技能的工作職位」。

從數據相關性計算出educ與profocc兩者的相關係數有0.5967681，的確有明顯的顯著。進而可以推估，如果是亮領職業人士的話，其wage可能比較高，經計算得出兩者的相關係數為0.4417699，的確此變數影響educ與wage，故單純比較wage與educ的關係，有可能只是在反映「是否為亮領職業人士」
...
```
教育年限為12-16年，可能是高中讀的比一般人久，或是大學讀到一半放棄的情況。
```
