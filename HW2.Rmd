...
```
因為勞工若屬於工會者可能得以抑制工時過長或者薪資過低等現象，故若未加入勞工屬於工會此工具變數可能會造成勞動供給的工資係數估計偏誤而高估工資係數。
```
...
```
在教育水準方面，通常較有技術性的工作，可能需要有一定知識的員工才可以勝任，因此廠商可能會願意用比較高的薪資聘任此類員工，且在工作量不變的情況下，其工作時數可能會較未學有此技術的員工低。
在性別方面，需冒較高風險的工作，例如駕駛公車以及工地施工等，通常會比較希望由男性來擔任，且其工作時數通常較長，而廠商為了提高員工的工作意願，也會願意以較高的報酬來雇用員工。
