...
```
1.產業別和薪資有關。產業別不同，則個別產業的勞動供需狀況不同。熱門產業或替代性低
的產業薪資較高，低技術或替代性高的產業薪資較低。
  產業別和誤差項無關，因為各產業平均而言，都有特性不一的勞動人口
  (例如:大學學歷也可能從事低技術行業)。可滿足排除性條件。
2.居住地和薪資有關。居住地反映一地的生活條件，通常能負擔較好的居住條件，可能隱含
他有較高的薪資。
  居住地和誤差項無關。因為各居住地平均而言，都有特性不一的勞動人口。
