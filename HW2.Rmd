...
```
勞工是否屬於工會，可能會造成選擇性偏誤。因為工會的談判力量較強大，通常可以對雇主要求較高的薪資，所以加入公會的人薪資通常會比沒加入工會的人高。另外工會與雇主的談判也會包括工作時數的部分，工會可以向雇主要求較低的工時，所以藉由工會與雇主談判，加入工會的人可能其工時也會比沒加入公會的人低。
```
...
```
因為我們在同樣是否加入公會的人中，還是無法控制住「非薪資效應的勞動供給量」對薪資與工時關聯的干擾，所以加入控制變數以改善此問題。
1.教育水準：通常教育水準越高，其薪資也會較高，就像碩士、學士的起薪不同，不過如果在同樣的薪資下，教育水準的高低便不會直接影響工作時數，所以我們可以找教育水準當控制變數。
2.性別：因為職場的性別歧視，通常男性平均薪資會比女性平均薪資高，不過如果在同樣的薪資下，是男性或女性便不會直接影響到工作時數，所以我們可以找性別當控制變數。
```
