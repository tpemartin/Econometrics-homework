...
```{r}
labordata %>% plot(WKS ~ LWAGE, data=., xlab="WKS", ylab="LWAGE")
```
...
```
加入工會者，受到工會保護，工時應該較短，同時公會具有勞動供給的談判力，故公會成員薪資應該較高。因此我們會擔心會低估係數。表示事實上薪水高我們應該很樂意工作，但加上了工會保護，我們反而可能工時更短。
```
...
```
<<<<<<< HEAD
簡單迴歸不顯著，複迴歸顯著。係數表示增加薪水對工時的誘因影響，又在複迴歸中係數比簡單迴歸係數更大，表示簡單迴歸中，我們低估了薪水對工時的誘惑力，其實工時變短可能是因為其它因素導致不會(想)工作那麼多。
=======
簡單迴歸不顯著，複迴歸顯著。係數表示增加薪水對工時的誘因影響，又在複迴歸中係數比簡單回歸係數更大，表示簡單迴歸中，我們低估了薪水對工時的誘惑力，其實工時變短可能是因為其它因素導致不會(想)工作那麼多。
>>>>>>> 1bc2f31c29b9d2ca62e8b074d9c2b4cbc94cf118
```
