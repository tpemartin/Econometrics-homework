...
假如我們沒有控制住union這個變數，可能會產生遺漏變數的問題。通常來說，會加入公會的都是那些高薪資的老師、醫生所組成的工會，就像我們常常看到的教師工會，因此我們可以知道加入工會的人通常與薪資成正相關，造成高估工資係數。
不過有些不同的國家，大部分是因為權益受損所組成的工會，例如之前鬧得沸沸揚揚的華航所組成的工會，組成自救式的臨時工會，產生低估工資系數。
```
